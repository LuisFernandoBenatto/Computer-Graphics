...
document.getElementById('btn-redscale').addEventListener('click', redScale);
document.getElementById('btn-redscale-cie').addEventListener('click', redScaleCIE);
document.getElementById('btn-redscale-ntsc').addEventListener('click', redScaleNTSC);