...
document.getElementById('btn-greenscale').addEventListener('click', greenScale);
document.getElementById('btn-greenscale-cie').addEventListener('click', greenScaleCIE);
document.getElementById('btn-greenscale-ntsc').addEventListener('click', greenScaleNTSC);
